...
# storage
AWS_S3_ENDPOINT_URL = os.getenv('https://storage.iran.liara.space')
AWS_STORAGE_BUCKET_NAME = os.getenv('university-association')
AWS_ACCESS_KEY_ID = os.getenv('5qpvoceqcq59uvrd')
AWS_SECRET_ACCESS_KEY = os.getenv('c6575249-a64b-4e98-a726-ef84bcebc27b')
